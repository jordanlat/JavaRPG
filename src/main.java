	...
	public static void main (String[] args) {
		...
		while(choose == true) {
			...
			if(choo_rep.equals("aventure")) {
				trait(30);
				Terminal.ecrireStringln("Oh non un individu hostile appara�t !");
				trait(30);
				...
				while(in_fight == true) {
					...
					if (fight_rep.equals("attaquer")) {
						...
						if(hero.life >= default_hero_life) {
							Terminal.sautDeLigne();
							Terminal.ecrireStringln("Votre santée est déà� au maximum.");
							Terminal.sautDeLigne();
						} else {
							Terminal.sautDeLigne();
							Terminal.ecrireStringln("Vous avez �t� soigné de " + hero.heal() + " points de vie.");
